...
function minicart() {
    ...
    function template(){
        return [
            ...
            '    <div class="minicart text-primary">',
            '       <i class="fa fa-shopping-cart"></i> {{\'Shopping\' | r | xlat}} {{\'Cart\' | r | xlat}}',
            '       <span ng-if="currentOrder.LineItems.length">&nbsp;-&nbsp;',
            '           <small class="items-label">{{currentOrder.LineItems.length}} {{\'Item\' | r | xlat}}<span ng-if="currentOrder.LineItems.length > 1">(s)</span></small>',
            '       </span>',
            '           {{currentOrder.Total || 0.00 | currency }}',
            ...
            '            <div class="row">',
            '                <div class="col-xs-6">',
            '                    <a class="btn btn-default btn-block" ng-disabled="!cartCount" href="cart">View Cart</a>',
            '                </div>',
            '                <div class="col-xs-6">',
