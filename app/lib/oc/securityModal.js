...
function SecurityModalCtrl($scope, $modal) {
    ...
    $scope.openSecurity = function (size) {
        ...
        function securitymodalopen() {
            return [
                '<style>',
                '.modal-dialog {top:160px;}',
                '.modal-header {border-bottom: 1px solid #ccc; min-height: 36px; padding: 2px;}',
                '.modal-header h5 { font-size:1.16em; font-weight:bold; padding:5px 10px; text-shadow: 0 1px 0 #ffffff; color:#ffffff; text-transform:uppercase;}',
                ...
                '<h5 class="modal-title text-primary">Concerned about Security?</h5>',
